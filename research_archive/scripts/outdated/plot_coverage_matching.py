...
def main():
    ...
    if args.which in ("all", "fractions_spend"):  # ✅ wire new chart
        stacked_paired_unmatched_fraction_spend_by_vintage(
            breakdown, unmatched_v,
            out_dir / "paired_unmatched_fractions_by_spend.png"
        )
